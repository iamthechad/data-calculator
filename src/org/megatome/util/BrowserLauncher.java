...
public class BrowserLauncher {
	 ...
	 */
	private BrowserLauncher() { // non-public ctor
	}
	...
	public static void openURL(String url) throws IOException {
		...
		Object myBrowser = locateBrowser();
		if (myBrowser == null) {
		...
		switch (jvm) {
			case MRJ_2_0:
				...
				try {
					...
					putParameter.invoke(myBrowser, new Object[] { keyDirectObject, aeDesc });
					sendNoReply.invoke(myBrowser, new Object[] { });
				} catch (InvocationTargetException ite) {
					...
					myBrowser = null;	// Ditto
				}
				break;
			case MRJ_2_1:
				Runtime.getRuntime().exec(new String[] { (String) myBrowser, url } );
				break;
			case MRJ_3_0:
		    ...
		    case WINDOWS_9x:
		    	...
		    	// characters to work.
				Process process = Runtime.getRuntime().exec(new String[] { (String) myBrowser,
			...
			case OTHER:
				...
				process = Runtime.getRuntime().exec(new String[] { (String) myBrowser,
